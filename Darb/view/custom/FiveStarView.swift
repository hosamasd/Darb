...
public struct FiveStarView: View {
    ...
    public init(
        rating: Decimal,
        color: Color = Color(#colorLiteral(red: 0.9777446389, green: 0.7635785937, blue: 0.2435026169, alpha: 1)),//.red,
        backgroundColor: Color = Color(#colorLiteral(red: 0.8104327917, green: 0.8135002255, blue: 0.8172994256, alpha: 1))//ColorConstants.starEmpt
    ) {
        self.rating = rating
        self.color = color
